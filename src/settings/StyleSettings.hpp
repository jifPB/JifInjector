...
namespace Jif
{
	...
	namespace Settings
	{
		...
		private:
			...
			Vector4 mBackgroundColor = {0.10f, 0.11f, 0.14f, 1.0f};
			Vector4 mTextColor = {0.94f, 0.95f, 0.98f, 1.0f};
			Vector4 mBorderColor = {0.24f, 0.26f, 0.34f, 1.0f};
			Vector4 mButtonColor = {0.38f, 0.34f, 0.92f, 1.0f};
		};
	}
}
